...
Xall = tr(Xall)
Y1 = [7.9 + 3.9*X1[i] + 8.7*X2[i] + 6.8*X3[i] + 6*X8[i] + 0.8*X9[i] + 7.8*X10[i] + 2*X12[i] + 0.8*X13[i] + 0.5*X23[i] + 5.1*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
Y2 = [7.9 + 3.9*X1[i] + 8.7*X2[i] + 6.8*X3[i] + 6*X8[i] + 0.8*X9[i] + 7.8*X10[i] + 2*X12[i] + 0.8*X13[i] + 0.5*X23[i] + 5.1*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
Y3 = [7.9 + 3.9*X1[i] + 8.7*X2[i] + 6.8*X3[i] + 6*X8[i] + 0.8*X9[i] + 7.8*X10[i] + 2*X12[i] + 0.8*X13[i] + 0.5*X23[i] + 5.1*X123[i] + random.randrange(-5, 5, 1) for i in range(15)]
for i in range(15):
